...
<!--<![endif]-->
	<head>
		<meta charset="utf-8">
		<title>Portal-Displayer By Silencily</title>
		<meta name="description" content="portal displayer a Bootstrap-based, Responsive HTML5 Template">
		<meta name="author" content="org.silencer.silencily">
		...
		<!-- Font Awesome CSS -->
		<link href="${ctxStatic}/fonts/font-awesome/css/font-awesome.css" rel="stylesheet">

		<!-- Plugins -->
		<link href="${ctxStatic}/css/animations.css" rel="stylesheet">
	...
	<body class="no-trans">
					...
					<div class="col-md-4">
						...
						<div class="header-left clearfix">
							...
							<div class="logo smooth-scroll">
								<a href="#banner"><img id="logo" src="${ctxStatic}/images/logo.png" alt="Worthy"></a>
							</div>
					...
					<div class="col-md-12">
						...
						<div class="isotope-container row grid-space-20">
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="${ctxStatic}/images/portfolio-1.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item app-development">
								<div class="image-box">
									<div class="overlay-container">
										<img src="${ctxStatic}/images/portfolio-2.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="${ctxStatic}/images/portfolio-3.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item site-building">
								<div class="image-box">
									<div class="overlay-container">
										<img src="${ctxStatic}/images/portfolio-4.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item app-development">
								<div class="image-box">
									<div class="overlay-container">
										<img src="${ctxStatic}/images/portfolio-5.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="${ctxStatic}/images/portfolio-6.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item site-building">
								<div class="image-box">
									<div class="overlay-container">
										<img src="${ctxStatic}/images/portfolio-7.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="${ctxStatic}/images/portfolio-8.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="${ctxStatic}/images/portfolio-9.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item site-building">
								<div class="image-box">
									<div class="overlay-container">
										<img src="${ctxStatic}/images/portfolio-10.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="${ctxStatic}/images/portfolio-11.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item app-development">
								<div class="image-box">
									<div class="overlay-container">
										<img src="${ctxStatic}/images/portfolio-12.jpg" alt="">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <img src="${ctxStatic}/images/section-image-1.png" alt="">
                                <div class="space"></div>
                            </div>
                            <div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="media testimonial">
							<div class="media-left">
								<img src="${ctxStatic}/images/testimonial-1.png" alt="">
							</div>
							<div class="media-body">
					...
					<div class="col-md-4">
						<div class="media testimonial">
							<div class="media-left">
								<img src="${ctxStatic}/images/testimonial-2.png" alt="">
							</div>
							<div class="media-body">
					...
					<div class="col-md-4">
						<div class="media testimonial">
							<div class="media-left">
								<img src="${ctxStatic}/images/testimonial-3.png" alt="">
							</div>
							<div class="media-body">
						...
						<div class="row">
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="${ctxStatic}/images/client-1.png" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="${ctxStatic}/images/client-2.png" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="${ctxStatic}/images/client-3.png" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="${ctxStatic}/images/client-4.png" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="${ctxStatic}/images/client-5.png" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="${ctxStatic}/images/client-6.png" alt="client">
								</div>
							</div>
						</div>
					</div>
		...
		<footer id="footer">
			...
			<div class="subfooter">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<p class="text-center">Copyright © 2015 Portal-Displayer by <a target="_blank" href="http://silencily.github.io">Silencily</a>.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript" src="${ctxStatic}/plugins/jquery.min.js"></script>
		<script type="text/javascript" src="${ctxStatic}/bootstrap/js/bootstrap.min.js"></script>

		<!-- Modernizr javascript -->
		<script type="text/javascript" src="${ctxStatic}/plugins/modernizr.js"></script>

		<!-- Isotope javascript -->
		<script type="text/javascript" src="${ctxStatic}/plugins/isotope/isotope.pkgd.min.js"></script>
		
		<!-- Backstretch javascript -->
		<script type="text/javascript" src="${ctxStatic}/plugins/jquery.backstretch.min.js"></script>

		<!-- Appear javascript -->
		<script type="text/javascript" src="${ctxStatic}/plugins/jquery.appear.js"></script>

		<!-- Initialization of Plugins -->
		<script type="text/javascript" src="${ctxStatic}/js/template.js"></script>

		<!-- Custom Scripts -->
		<script type="text/javascript" src="${ctxStatic}/js/custom.js"></script>
