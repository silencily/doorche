  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg"><spring:message code="ui.login.txt.title" /></p>
        <form action="${ctx}/j_spring_security_check" method="post">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="<spring:message code='ui.login.txt.username' />" name="j_username">
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="<spring:message code='ui.login.txt.password' />" name="j_password">
          ...
          <div class="row">
            <div class="col-xs-8">
              <div class="checkbox icheck">
                <label>
                  <input type="checkbox" name="_spring_security_remember_me"> <spring:message code='ui.login.txt.rememerme' />
                </label>
              </div>
            </div><!-- /.col -->
            <div class="col-xs-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat"><spring:message code='ui.login.btn.signin' /></button>
            </div><!-- /.col -->
          </div>
        </form>
      </div><!-- /.login-box-body -->
